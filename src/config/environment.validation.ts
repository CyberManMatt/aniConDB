...
export default Joi.object({
  ...
  POSTGRES_USER: Joi.string().required().default('anicondbdev'),
  ...
  JWT_TOKEN_AUDIENCE: Joi.string().required().default('localhost'),
  JWT_TOKEN_ISSUER: Joi.string().required().default('localhost'),
